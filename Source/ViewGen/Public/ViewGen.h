...
/**
 * Main module for ViewGen - AI Viewport Generator plugin.
 * Registers the editor tab, toolbar extension, and manages plugin lifecycle.
 */
class FViewGenModule : public IModuleInterface
{
public:
...
private:
	...
	static const FName ViewGenTabName;
};
