...
{
	return FPaths::ProjectSavedDir() / TEXT("UE_Gen") / TEXT("Presets");
}
...
bool UGenAISettings::SavePreset(const FString& PresetName)
{
	...
	{
		UE_LOG(LogTemp, Log, TEXT("UE_Gen: Preset saved: %s"), *FilePath);
		return true;
	}

	UE_LOG(LogTemp, Error, TEXT("UE_Gen: Failed to save preset: %s"), *FilePath);
	return false;
}
...
bool UGenAISettings::LoadPreset(const FString& PresetName)
{
	...
	{
		UE_LOG(LogTemp, Error, TEXT("UE_Gen: Preset file not found: %s"), *FilePath);
		return false;
	}
	...
	{
		UE_LOG(LogTemp, Error, TEXT("UE_Gen: Failed to parse preset: %s"), *FilePath);
		return false;
	}
	...
	S->SaveConfig();
	UE_LOG(LogTemp, Log, TEXT("UE_Gen: Preset loaded: %s"), *PresetName);
	return true;
}
...
bool UGenAISettings::DeletePreset(const FString& PresetName)
{
	...
	{
		UE_LOG(LogTemp, Log, TEXT("UE_Gen: Preset deleted: %s"), *PresetName);
		return true;
	}

	UE_LOG(LogTemp, Error, TEXT("UE_Gen: Failed to delete preset: %s"), *FilePath);
	return false;
}
