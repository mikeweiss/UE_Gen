...
/**
 * Plugin settings for UE Gen - configurable via Project Settings > Plugins > UE Gen.
 * Configured for ComfyUI Desktop by default.
 */
UCLASS(config = EditorPerProjectUserSettings, defaultconfig, meta = (DisplayName = "UE Gen - AI Viewport Generator"))
...
public:
	...
	virtual FName GetSectionName() const override { return FName(TEXT("UE Gen")); }
