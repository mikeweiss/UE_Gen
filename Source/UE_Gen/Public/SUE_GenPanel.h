...
/**
 * Main Slate panel widget for UE Gen.
 *
 * Layout:
 * ┌────────────────────────────────────────────┐
 ...
 * └────────────────────────────────────────────┘
 */
class SUE_GenPanel : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SUE_GenPanel) {}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs);
	virtual ~SUE_GenPanel();
...
private:
	 ...
	 *  @param AssetPath      Content browser destination path (e.g. "/Game/UE_Gen/MeshyModels")
